...
from phtrans.inference.predict import predict_from_folder
from nnunet.paths import default_plans_identifier, network_training_output_dir, default_cascade_trainer, default_trainer
from batchgenerators.utilities.file_and_folder_operations import join, isdir
from nnunet.utilities.task_name_id_conversion import convert_id_to_task_name
from nnunet.paths import nnUNet_raw_data
from phtrans.inference import metrics
...
def main():
    ...
    #                          "Do not touch this.")
    parser.add_argument("--metrics", required=False, default=False, action="store_true",
                        help="custom metrics")
    ...
    if args.metrics:
        metrics(output_folder,experiment_id,task_id)
